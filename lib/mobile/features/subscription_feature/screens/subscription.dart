          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16.sp),
                Obx(() => controller.hasUsedTrial.value 
                  ? Text('Оформите подписку на месяц', style: TextStyles.titleSmall)
                ...
                Text(
                  'Подписка автоматически продлевается, если её не отменить до окончания текущего периода.',
                  style: TextStyles.labelMedium.copyWith(color: Palette.grey350)
                ),
                const Spacer(),
                Column(
                  children: [
                    Obx(() => SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (controller.hasUsedTrial.value) {
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              controller.hasUsedTrial.value ? 'Оформить подписку' : 'Начать пробный период',
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Пробный период', style: TextStyles.titleLarge),
                Container(
                  width: double.infinity,
                  height: 1,
                ...
                SizedBox(height: 16.sp),
                Text(
                  'Получите доступ ко всем функциям на 7 дней бесплатно',
                  style: TextStyles.bodyMedium.copyWith(color: Palette.grey350)
                ),
                SizedBox(height: 16.sp),
                const SubscriptionCard(),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      try {
                        await controller.startTrialPeriod();
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 8.sp),
                                    Text(
                                      'Наслаждайтесь всеми премиум функциями в течение 7 дней.',
                                      style: TextStyles.bodyMedium.copyWith(color: Palette.grey350),
                                      textAlign: TextAlign.center,
                                    ),
                                    SizedBox(height: 16.sp),
                    ...
                    child: Text('Начать пробный период', style: TextStyles.buttonSmall),
                  ),
                ),
                SizedBox(height: 8.sp),
              ],
                ...
                Obx(() => SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: controller.selectedCard.value != null
                        ? () async {
                            try {
                              await controller.purchaseMonthlySubscription();
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 8.sp),
                                          Text(
                                            'Вы успешно оплатили подписку на 30 дней. Теперь вам доступны все функции приложения.',
                                            style: TextStyles.bodyMedium.copyWith(color: Palette.grey350),
                                            textAlign: TextAlign.center,
                                          ),
                                          SizedBox(height: 16.sp),
